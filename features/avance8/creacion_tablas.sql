...
-- Started on 2026-05-22 19:31:32
...
--
-- TOC entry 5342 (class 1262 OID 33494)
-- Name: SVA Law; Type: DATABASE; Schema: -; Owner: -
--

CREATE DATABASE "SVA Law" WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'Spanish_Mexico.1252';
...
CREATE TABLE public.tf_catalogos (
    ...
    incremento_vs_monto_anterior numeric(18,6),
    senial_alerta_historica numeric(18,6),
    cambio_listas_peps numeric(18,6)
);
